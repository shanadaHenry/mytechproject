            ...
            return(
                <View>
                    <Fab style={styles.menu_fab}
                        ...
                        onPress={()=> navigate('MenuAdd',{data: null, refresh: this._onRefresh})}>
        ...
        if(this.props.user_role === "admin") {
            ...
            <View style={styles.menu_action_view}>
                <Ripple 
                    ...
                    onPress={()=> navigate('MenuAdd',{data: item, refresh: this._onRefresh})}>
                ...
                <Ripple rippleColor='#FFF' style={[styles.menu_action, {backgroundColor: '#E51D1D'}]} onPress={() => {
                    Alert.alert(
                        ...
                        [
                            {text: 'Yes', onPress: () => this._deleteMenu(item.id_menu)},
