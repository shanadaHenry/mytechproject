...
class HomeScreen extends Component {
  ...
  render() {
    ...
    const menu = [
      { id: 1, name: "KamarMandi", icon: "cutlery", screen: "Menu", color: '#73E859', color_dark: '#' },
      { id: 2, name: "AC", icon: "coffee", screen: "Menu", color: '#73E859', color_dark: '#' },
      { id: 3, name: "Parabola", icon: "window-maximize", screen: "Menu", color: '#73E859', color_dark: '#' },
