    ...
    render() {
        ...
        return (
            <Container>
                <Content padder>
                    <View>
                        <Text>{detail_menu.id_tickets}</Text>
                        <Text>{detail_menu.lokasi}</Text>
                        <Text>{detail_menu.masalah}</Text>
                        <Text>{detail_menu.desk_masalah}</Text>
                        <Text>{detail_menu.nama_kategori}</Text>
