            ...
            <Container>
                <Content>
                    ...
                    <View>
                        ...
                        <Text>{data_user.email_cust}</Text>
                        <Text>{data_user.id_cust}</Text>
                        <Text>{data_user.nama_cust}</Text>
                        <Text>{data_user.email_tech}</Text>
                        <Text>{data_user.nama_tech}</Text>
                        <Text>{data_user.status}</Text>
                        <Text>{data_user.id_tech}</Text>
