...
class MenuEditCustomersScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _saveData = () => {
        ...
        var url_name = (menu_id != null) ? 'EDIT-CUSTOMERS' : 'TAMBAH-CUSTOMERS';
        const headers = {
        ...
        requestData(headers, body, request_url).then((data) => {
            ...
            var nama = (request_url === "EDIT_CUSTOMERS") ? "perubahan" : "penambahan";
            if (status == 200) {
                Alert.alert(
                    'Berhasil',
...
export default connect(mapStateToProps)(MenuEditCustomersScreen);
