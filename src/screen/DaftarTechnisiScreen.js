...
class DaftarTechnisiScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            telp_tech: '',
    ...
    _userSignup() {
        ...
        const body = {
            ...
            telp: this.state.telp_tech,
            first_name: this.state.nama_tech,
        ...
        requestData(headers, body, request_url).then((data) => {
            ...
            if(status.code == 200){
                Alert.alert(
                    'Berhasil Mendaftarkan Technisi',
                )
                this._refreshMenu();
            }else {
                Alert.alert(
            ...
            <ImageBackground source={technisi_bg}
                ...
                <View>
                    <ScrollView>
                        ...
                        <Text style={styles.submitButtonText}> Daftar Technisi</Text>
                        ...
                        <TextField
                            ...
                            autoCorrect={false}
                            selectionColor="#FFF"
                            value={this.state.telp_tech}
                            onChangeText={(text) => this.setState({ telp_tech: text })}
                        ...
                        <TextField
                            ...
                            autoCorrect={false}
                            selectionColor="#FFF"
                            value={this.state.nama_tech}
                            onChangeText={(text) => this.setState({ nama_tech: text })}
                            placeholderTextColor='#FFF'
                            label='Nama Awal'
                        //controlled={true}
                        />
...
export default DaftarTechnisiScreen;
